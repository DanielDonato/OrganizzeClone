...
import com.example.danieldonato.organizzeclone.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    private TextView txtSaldo, txtSaldacao;
    ...
    public void excluirMovimentacao(final RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setMessage("Você tem certeza que deseja realmente excluir movimentação sua da conta");
    ...
    public void recuperarResumos(){
        ...
        valueEventListenerUsuario = usuarioRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                txtSaldo.setText(decimalFormat.format(resumoUsuario));
